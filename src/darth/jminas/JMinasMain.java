    ...
    static class Sonido extends Thread {
        ...
        public void run() {
            try {
                ...
                if(Perdedor)
                    JOptionPane.showMessageDialog(null, "Â¡BOO000000M!", "Error con el archivo de audio", JOptionPane.ERROR_MESSAGE);
                else if(Ganador)
                    JOptionPane.showMessageDialog(null, "Â¡HAS GANADO!", "Error con el archivo de audio", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
